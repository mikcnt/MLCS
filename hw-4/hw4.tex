...
\begin{proof}
	...
	\begin{itemize}
		...
		\item Given two set of sentences $A$ and $B$ and their respective models $\mathfrak{A}$ and $\mathfrak{B}$, we can define the intersection between the two models $\mathfrak{A} \cup \mathfrak{B}$ as the class of structures that both satisfy $A$ and $B$.
	\end{itemize}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.6\textwidth]{structures.pdf}
		\caption{We can see in the figure that the two models $\mathfrak{U}$ and $\mathfrak{V}$ must be disjoint, and that their union must be the class of all structures.}

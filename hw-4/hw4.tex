...
\begin{proof}
	...
	Therefore, according to the Compactness Theorem, it exists a finite subset $W \subseteq U_0 \cup V_0$ such that $W$ has no model. Let's assume that $W$ is made by a subset of sentences from $U$, say $U_0 = \{u_0, \dots, u_p\}$, and a set of sentences from $V$, say $V_0 = \{v_0, \dots, v_q\}$:
	
	\[
		W = U_0 \cup V_0 = \{u_0, \dots, u_p, v_0, \dots, v_q\}.
	\]
	
	Let's call the model for $U_0$ and $V_0$ respectively $\mathfrak{U}_0$ and $\mathfrak{V}_0$. We know that the models $\mathfrak{U}_0$ and $\mathfrak{V}_0$ are disjoint, that $\mathfrak{U} \subseteq \mathfrak{U_0}$ and that $\mathfrak{V} \subseteq \mathfrak{V_0}$. Moreover, $\mathfrak{U}_0 \cup \mathfrak{V}_0$ is the class of all models, and this means that $\mathfrak{U} = \mathfrak{U}_0$. We can therefore conclude that that $P$ is finitely axiomatizable (i.e., by the sentences in $U_0$).
